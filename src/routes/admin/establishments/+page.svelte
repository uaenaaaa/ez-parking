<script lang="ts">
    ...
    let establishments = data.establishments as Applicant[];
                  ...
                  {establishment.establishment.verified
                        ...
                        <div class="mt-4">
                            <div class="mb-2 flex items-center text-sm text-gray-500">
                                ...
                                <span
                                    >Lat: {establishment.establishment.latitude}, Long: {establishment
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">
                                        {establishment.establishment.space_type.toUpperCase()}
                                    </p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Layout</p>
                                    <p class="mt-1 text-sm text-gray-900">
                                        {establishment.establishment.space_layout.toUpperCase()}
                                    </p>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-500">Operating Hours</p>
                                    <p class="mt-1 text-sm text-gray-900">
                                        {establishment.establishment.is24_7 ? '24/7' : 'Custom Hours'}
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-900">
                                        {new Date(
                                            establishment.establishment.created_at
                                        ).toLocaleDateString()}
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href={`/admin/establishments/${establishment.establishment.uuid}`}
